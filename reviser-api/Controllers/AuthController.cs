...
namespace reviser_api.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public AuthController(UserManager<ApplicationUser> userManager, RoleManager<UserRole> roleManager)
        {
        ...
        private async Task<LoginResponse> LoginAsync(LoginRequest request)
        {
            try
            {
                ...
                var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("2swek3u4uo2u4a6e"));
